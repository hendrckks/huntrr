          ...
          <div className="flex flex-wrap gap-2">
            {propertyTypes.map((type) => (
              <Badge
                ...
                className={`cursor-pointer text-sm py-2 px-3 font-medium dark:hover:bg-white/70 hover:bg-[#121212]/90 bg-black/85 dark:bg-white/80 dark:text-black text-white transition-colors ${
          ...
          <div className="flex flex-wrap gap-2">
            {bedroomOptions.map((option) => (
              <Badge
                ...
                className={`cursor-pointer text-sm py-2 px-3 hover:bg-[#121212]/90 dark:hover:bg-white/70 bg-black/85 dark:bg-white/80 dark:text-black text-white font-medium transition-colors ${
