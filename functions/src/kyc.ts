...
export const onKYCSubmitted = onDocumentCreated("kyc/{userId}", async (event) => {
  ...
  try {
    ...
    await notificationRef.set({
      ...
      message: `A new KYC document has been submitted for verification`,
...
export const processKYC = onCall(
  ...
  async (request) => {
    ...
    try {
      ...
      if (approved) {
        ...
        await admin.auth().setCustomUserClaims(userId, { role: "landlord_verified" });
      }
